...
from widgets.file_overlays import FileSaveOverlay, FileLoadOverlay
from widgets.messages import EditNode, FileSelected

from example_structures import category_tree

TEST_DICT = category_tree
...
class PromptApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        self.prompt_tree.root.data = {"key": "root", "value": TEST_DICT}
        yield self.prompt_tree
        yield Footer()

    def on_mount(self) -> None:
        self._populate_tree(TEST_DICT, parent=self.prompt_tree.root)
